...
public class HEFT extends ModulePlacement{

    protected ModuleMapping moduleMapping;
    protected List<Sensor> sensors;
    protected List<Actuator> actuators;
    protected Map<Integer, Double> currentCpuLoad;
    protected int nbArea;
    protected int nbCamera;
    /**
    ...
    public HEFT(List<FogDevice> fogDevices, List<Sensor> sensors, List<Actuator> actuators,
    ...
    protected void mapModules() {
        ...
        List<AppModule> modules= app.getModules();
        for(List<Integer> path : leafToRootPaths){
            //Map<String,Integer> costs= cost(path,modules);
        ...
        for(int deviceId : getCurrentModuleMap().keySet()){
           ...
           // System.out.println("hetha khdim");
        }
    }
    ...
    private void placeModulesInPath(List<Integer> path) {
        ...
        //System.out.println("place module");
  ...
  /*  private Map<String,Integer> cost (List<Integer> path, List<AppModule>modules){
     //       Double w= timeProce();
    }
    private Double timeProce (AppModule module, List<Integer> path){
            ...
            if(getCurrentCpuLoad().get(id) + totalCpuLoad > fogDevice.getHost().getTotalMips()){
                ...
                for(String module : _modulesToShift){
                    if(!modulesToShift.contains(module)){
                        System.out.println(module +"hetha 3mal mochkil");
    ...
    public void setnbrcamera(int nb)
    {
        this.nbCamera=nb;
    }
