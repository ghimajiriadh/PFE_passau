...
public interface Constants {
	...
	final String Load_Balancing_HEFT="HEFT";
	final String Load_Balancing_SJF="SJF";
	final String Load_Balancing_SJFB="SJF_Cloudlet";
	...
	final String BROKER_POLICY_ant = "ant cloney";
