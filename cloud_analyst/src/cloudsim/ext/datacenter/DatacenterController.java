...
public class DatacenterController extends DatacenterBroker implements GeoLocatable,
	...
	public DatacenterController(String name, 
		...
		else if (loadBalancePolicy.equals(Constants.Load_Balancing_HEFT)) {
			this.loadBalancer = new heft(this);
		}
		else if (loadBalancePolicy.equals(Constants.Load_Balancing_SJF)) {
			this.loadBalancer = new SJF_VmLoadBalance(this);
		}
		else if (loadBalancePolicy.equals(Constants.Load_Balancing_SJFB)) {
